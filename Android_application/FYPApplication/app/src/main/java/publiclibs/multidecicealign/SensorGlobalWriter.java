...
public class SensorGlobalWriter extends Observable implements SensorEventListener {
    ...
    public SensorGlobalWriter(String fileName, Context context) {
        ...
        try {
            fileWriter = new FileWriter(new File(context.getExternalFilesDir(null), fileName));
    ...
    public void setFileName(String fileName, Context context) throws IOException {
        try {
            fileWriter = new FileWriter(new File(context.getExternalFilesDir(null), fileName));
            fileWriter.write(cuShakingData.getCSVHead());
            fileWriter.flush();
